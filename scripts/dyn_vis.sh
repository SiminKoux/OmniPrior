...
# Note: The --dyn_app_threshold value may need adjustment for different scenes
# Paper settings: the 'suite' scene uses 0.6; the 'concert' scene uses 0.66
