# OmniPrior
This repository is the official PyTorch implementation of [OmniPrior](https://ieeexplore.ieee.org/document/xxx), which was accepted by TVCG. You can watch our [video demo](https://vimeo.com/xxx) here.
